...
class Main:
	...
	def SetupSettingsScreen(self):
		...
		piece = Piece.UiPiece([20, 375], [113, 100], "Button")
		...
		piece = Piece.UiPiece([133, 375], [113, 100],
                  "Button_Black")
		...
		piece = Piece.UiPiece([246, 375], [113, 100],
                  "Button")
		piece.SetUpButton(False, "Button_Hover",
                    "Button_Pressed",
					onClick=self.ChangeVolume, onClickData=1)
		...
		#level select row 2
		piece = Piece.UiPiece([20, 490], [113, 100],
                  "Button")
		piece.SetUpButton(False, "Button_Hover",
                    "Button_Pressed",
		...
		piece = Piece.UiPiece([133, 490], [113, 100],
                  "Button_Black")
		...
		piece = Piece.UiPiece([246, 490], [113, 100],
                  "Button")
		piece.SetUpButton(False, "Button_Hover",
                    "Button_Pressed",
					onClick=self.ChangeLevelSelect, onClickData=1)
		...
		piece = Piece.UiPiece([20, 595], [113, 100],
                  "Settings_Button")
		...
		piece = Piece.UiPiece([135, 595], [113, 100],
                  debugButton)
	...
	def SetUpMainScreen(self):
		...
		#button Grid
		#row 1
		piece = Piece.UiPiece([20, 375], [113, 100],
                  "Button")
		piece.SetUpButton(False, "Button_Hover",
                    "Button_Pressed",
		...
		piece = Piece.UiPiece([133, 375], [113, 100], op.BaseImage)
		...
		#row 2
		piece = Piece.UiPiece([20, 485], [113, 100])
		self.Manger.AddPiece(piece, False)

		op = self.OperationsList[1]
		piece = Piece.UiPiece([133, 485], [113, 100], op.BaseImage)
		...
		piece = Piece.UiPiece([246, 485], [113, 100], op.BaseImage)
		...
		piece = Piece.UiPiece([133, 595], [113, 100], op.BaseImage)
		...
		piece = Piece.UiPiece([246, 595], [113, 100], op.BaseImage)
	...
	def SetUpOperationSelectScreen(self, gridIndex):
		...
		piece = Piece.UiPiece([xStart-10, yStart-10], [360, 450],
			"Popup_BackGround")
		self.Manger.AddPiece(piece, False)
		...
		for y in range(4):
			for x in range(3):
				...
				if op != None:
					piece = Piece.UiPiece([xStart+x*115, yStart+y*110], [110, 100],
						op.BaseImage)
